...
def load_documents(docs_path= "docs"):
    """Load all txt files fromthe docs directory"""
    print(f"Loading all documents from {docs_path}...")

    """Check if docs directory actually exists"""
    ...
    if len(documents) == 0:
        raise FileNotFoundError(f"No txt files where found in {docs_path}. Please add your company's documents")
